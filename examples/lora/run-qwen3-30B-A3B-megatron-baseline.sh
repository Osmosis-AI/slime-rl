#!/bin/bash
# Baseline (non-LoRA) run for Qwen3-30B-A3B — for benchmarking against LoRA.
# Same config as run-qwen3-30B-A3B-megatron-lora.sh but without --lora-* args.
...
MLFLOW_ARGS=(
   ...
   --mlflow-run-name qwen3-30B-A3B-gsm8k-baseline
)
